...
import ResponsiveImage from '@/components/ImageBox/ResponsiveImage';
import React from 'react';

export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative flex flex-col justify-start items-center pt-20 min-h-screen slash-gradient-l-r">
      {/* <Logo className="absolute z-10 mt-6 ml-8 md:mt-20 md:ml-20" /> */}
      <h3 className="mb-10 text-3xl font-semibold text-primary-content">
        Hi, Welcome to Slash
      </h3>
      <CardContainer className="flex md:flex-row flex-col justify-center items-center md:flex-wrap md:w-1/2 w-full h-1/2 border-none md:shadow-lg shadow-none md:glass bg-transparent rounded-lg">
        <div className="w-1/2 h-1/2 md:p-10 rounded-md md:flex hidden  ">
          <ResponsiveImage src="/auth_ill.svg" alt="" ratio="1/1" />
          {/* <svg
          ...
          >
            <path
              id="b10fb2cf-c586-4c5f-9fbf-e678f5ffa3db-66"
              data-name="Path 133"
            ...
            />
            <path
              id="a32c10c7-75df-4179-a648-6a8d2a687209-67"
              data-name="Path 134"
        ...
        <div className="flex-1  w-full flex md:items-center items-start justify-center p-4 md:min-w-60">
          {children}
        </div>
      </CardContainer>
    </div>
