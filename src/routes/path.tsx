...
export const PATH_DASHBOARD = {
  ...
  chat: {
    ...
    view: (name: any) => path(ROOTS_DASHBOARD, `/chat/${name}`)
  },
  user: {
  ...
  eCommerce: {
    ...
    view: (name: any) => path(ROOTS_DASHBOARD, `/e-commerce/product/${name}`),
    edit: (name: any) =>
  ...
  invoice: {
    ...
    edit: (id: any) => path(ROOTS_DASHBOARD, `/invoice/${id}/edit`),
    demoEdit: path(
      ROOTS_DASHBOARD,
  ...
  blog: {
    ...
    view: (title: any) => path(ROOTS_DASHBOARD, `/blog/post/${title}`),
    demoView: path(
      ROOTS_DASHBOARD,
